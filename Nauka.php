...
EXCERPT;
		...
		<figure class="main_theme" id="science_theme">
			<div>
				<h3>Nauka</h3>
				<p>Mauris fermentum nisl eu arcu aliquet malesuada. Vestibulum eget placerat eros. Aliquam lobortis magna sed tellus maximus congue nec sed nulla. Praesent nec rutrum arcu.</p>
			</div>
		</figure>
		...
		<section class="artykul_">
				...
				<img src="photos/n5.jpg" alt="obrazek">
				<p>
